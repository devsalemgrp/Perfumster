...
const ChoosePerfumeModal = ({
  ...
  const [perfumeChosen, setPerfumeChosen] = useState(null);
  const [isOpenConfirmModal, setIsOpenConfirmModal] = useState(false);
  useEffect(() => {
    dispatch(getProducts());
  }, [dispatch]);

  const openConfirmChoice = () => {
  ...
  useEffect(() => {
    if (subscription?.scents_number) {
      setPerfumes_number(subscription?.scents_number);
    }
  }, [subscription?.scents_number]);
  ...
  return (
    <div>
      <ConfirmModal
        perfume={perfumeChosen}
        isOpen={isOpenConfirmModal}
        onClose={closeConfirmChoice}
        setSubscriptionDetail={setSubscriptionDetail}
        setRemainingPerfumes={setPerfumes_number}
      />
      <Modal
        isOpen={isOpenModal}
        style={customStyles}
      ...
      >
        <div className="relative">
          {filterSelected && (
            <div className="absolute top-0 left-0 w-full h-auto bg-[rgb(2,2,2)] z-50 text-white">
              <div className="w-11/12 mx-auto py-10">
                <div className="slider-container w-full pb-10 ">
          ...
          <div className="w-full text-2xl ">
            Please select {subscription?.scents_number}{" "}
            {subscription?.scents_number > 1 ? "scents" : "scent"}
          </div>
          <div className="bg-[rgb(49,49,49)] py-10">
            ...
            <div className="w-11/12 mx-auto mt-5">
              <div className="bg-[#454545] p-3 lg:p-11">
                <form id="search" className="w-full flex flex-col gap-3">
                  <label className="text-white text-2xl helvetica">
                    Search
                  </label>
            ...
            <div className="w-11/12 mx-auto flex flex-col lg:flex-row mt-10 text-white">
              ...
              <div className="block lg:hidden pb-2">
                <div
                  className="w-1/2 sm:w-2/5 md:1/4 border text-center p-1 richmond_display flex flex-row items-center justify-center gap-2"
              ...
              <div className="w-full lg:w-3/4 grid grid-cols-1 md:grid-cols-3 gap-3">
                {perfumes &&
...
export default ChoosePerfumeModal;
